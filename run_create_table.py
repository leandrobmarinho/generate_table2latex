...
if __name__ == '__main__':
    ...
    num_test = 41
    print('**** Cerebro DICOM ****')
    for file in glob.glob('/Users/leandrobmarinho/Downloads/AVC/Cerebro_DICOM/results/*.csv'):
        create_table(file, classifiers, metrics, num_test, type)

    # metrics = ['test_accuracy']
    num_test = 41
    print('\n**** Cerebro Grayscale ****')
    for file in glob.glob('/Users/leandrobmarinho/Downloads/AVC/Cerebro_Grayscale/results/*.csv'):
        create_table(file, classifiers, metrics, num_test, type)
